...
public class StandardProblems extends ProblemProvider {
	...
	//public String fileName2 = "HNCA.peaks";

	public String fileName = "knapsack.283.11.3";
	public String fileName_chem = "knapsack.283.11.3";
	...
	public Problem getProblem(String name) {
		...
		try {
			...
			if (name.startsWith("DTLZ1")) {
				...
				return new Knapsack (new File ("src/org/moeaframework/problem/Knapsack/" + fileName));
			} else if (name.startsWith("CHEMICALSHIFTASSIGNMENT")) {	
				return new chemicalShiftAssignment (new File ("src/org/moeaframework/problem/chemicalShiftAssignment/" + fileName_chem));
	...
	public NondominatedPopulation getReferenceSet(String name) {
		...
		try {
			if (name.startsWith("DTLZ1")) {
				...
				return loadReferenceSet(fileName_chem + ".pf");
			} else if (name.startsWith("KNAPSACK")) {
				return loadReferenceSet(fileName + ".pf");
			} else if (name.startsWith("WFG1")) {
				int numberOfObjectives = Integer.parseInt(name.substring(5));
