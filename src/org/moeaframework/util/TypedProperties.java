...
public class TypedProperties {
	...
	//EMEL	System.out.println("key: "+ key);

		if (value == null) {
	//EMEL		System.out.println("set to default value: "+ defaultValue);
			return defaultValue;
		} else {
		//EMEL	System.out.println("set to manually set value: " + Double.parseDouble(value));
